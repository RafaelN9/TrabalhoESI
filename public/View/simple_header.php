...
<body>
    <div class="container-fluid h-100 p-0 bg-img">
        <nav class="navbar navbar-light d-flex justify-content-center bg-princ-escuro">
        ...
        <div class="container-fluid bg-secundaria" style="min-height: 100%;">